...
| `Database__MaxPoolSize` | No | `10` | Local Npgsql connection-pool cap for the API process. Keep this below the Supabase session-pool `pool_size` (for example, below 15) so background workers queue locally instead of exhausting Supabase client slots. |
