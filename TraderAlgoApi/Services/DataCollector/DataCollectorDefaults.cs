...
public static class DataCollectorDefaults
{
    ...
    /// Providers are queried from this date forward, so full syncs backfill since 2015.
    /// </summary>
    public static readonly DateTimeOffset DataStartDate = new(2015, 1, 1, 0, 0, 0, TimeSpan.Zero);
