...
namespace TraderAlgoApi.Migrations
{
    ...
    [Migration("20260428232929_AddKlineDataIndicators")]
    partial class AddKlineDataIndicators
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TraderAlgoApi.Models.KlineDataIndicator", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("KlineDataId")
                        .IsUnique();

                    b.ToTable("kline_data_indicators");
                });
            ...
            modelBuilder.Entity("TraderAlgoApi.Models.KlineDataIndicator", b =>
                {
                    b.HasOne("TraderAlgoApi.Models.KlineData", "KlineData")
                        .WithOne("Indicator")
                        .HasForeignKey("TraderAlgoApi.Models.KlineDataIndicator", "KlineDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
