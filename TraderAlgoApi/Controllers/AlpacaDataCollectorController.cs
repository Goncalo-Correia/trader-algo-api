...
[ApiController]
[Route("api/alpaca/data-collector")]
public sealed class AlpacaDataCollectorController(
    ApplicationDbContext dbContext,
    IAlpacaDataCollectorService dataCollectorService) : ControllerBase
{
    ...
    {
        var (symbols, intervals) = await LoadAlpacaSymbolsAndIntervalsAsync(cancellationToken);
    ...
    private async Task<(List<Models.Symbol> Symbols, List<Models.Interval> Intervals)>
        LoadAlpacaSymbolsAndIntervalsAsync(CancellationToken cancellationToken)
    {
